  ...
  <div>
    ...
    <Modal v-model="modal.menuModal" title="菜单">
      <Form :model="workPara" :label-width="80" :rules="formRule.ruleMenuModal" ref="formMenu">
        ...
        <Divider orientation="left">移动端参数</Divider>
        <FormItem label="图标" prop="systemmenu_mobile_icon">
          <Input placeholder="图标" v-model="workPara.systemmenu_mobile_icon"/>
        </FormItem>
        <FormItem label="背景颜色" prop="systemmenu_mobile_backcolor">
          <Input placeholder="背景颜色" v-model="workPara.systemmenu_mobile_backcolor"/>
        </FormItem>
      </Form>
      <div slot="footer">
    ...
    editNode: async function() {
      try {
        ...
        if (this.actNode.node_type === '00') {
          ...
          this.workPara.systemmenu_id = this.actNode.systemmenu_id
          this.workPara.systemmenu_name = this.actNode.systemmenu_name
          this.workPara.systemmenu_mobile_icon = this.actNode.systemmenu_mobile_icon
          this.workPara.systemmenu_mobile_backcolor = this.actNode.systemmenu_mobile_backcolor
